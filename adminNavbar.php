...
<body>
     ...
     <div>
        <nav class="navbar">
            ...
            <div class="left-div">
                <a href="adminPage.php" id="ticket-btn">ADMINISTRATORS</a>
                <a href="buyersTable.php" id="order-btn">BUYERS</a>
                <a href="reservationsPage.php" id="profile-btn">RESERVATIONS</a>
            </div>
